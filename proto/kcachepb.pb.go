...
func (x *Request) Reset() {
	*x = Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kcachepb_proto_msgTypes[0]
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_kcachepb_proto_rawDescGZIP(), []int{0}
}
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kcachepb_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_kcachepb_proto_rawDescGZIP(), []int{1}
}
...
var File_kcachepb_proto protoreflect.FileDescriptor

var file_kcachepb_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x6b, 0x63, 0x61, 0x63, 0x68, 0x65, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_kcachepb_proto_rawDescOnce sync.Once
	file_kcachepb_proto_rawDescData = file_kcachepb_proto_rawDesc
)

func file_kcachepb_proto_rawDescGZIP() []byte {
	file_kcachepb_proto_rawDescOnce.Do(func() {
		file_kcachepb_proto_rawDescData = protoimpl.X.CompressGZIP(file_kcachepb_proto_rawDescData)
	})
	return file_kcachepb_proto_rawDescData
}

var file_kcachepb_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_kcachepb_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: Request
	(*Response)(nil), // 1: Response
}
var file_kcachepb_proto_depIdxs = []int32{
...
func init() { file_kcachepb_proto_init() }
func file_kcachepb_proto_init() {
	if File_kcachepb_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_kcachepb_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_kcachepb_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_kcachepb_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_kcachepb_proto_goTypes,
		DependencyIndexes: file_kcachepb_proto_depIdxs,
		MessageInfos:      file_kcachepb_proto_msgTypes,
	}.Build()
	File_kcachepb_proto = out.File
	file_kcachepb_proto_rawDesc = nil
	file_kcachepb_proto_goTypes = nil
	file_kcachepb_proto_depIdxs = nil
}
